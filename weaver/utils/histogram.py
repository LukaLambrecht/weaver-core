# Re-implementation of torch.histogram to enable CUDA support.

# Copied from here: https://github.com/francois-rozet/torchist/blob/master/torchist/__init__.py
# Found via this issue: https://github.com/pytorch/pytorch/issues/69519
# Used in flatness loss calculation.
