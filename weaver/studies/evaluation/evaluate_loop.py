...
if __name__=='__main__':
    ...
    for inputfile in args.inputfiles:
        ...
        # load events
        events = get_events_from_file(inputfile, args.signal_mask,
                  treename=args.treename, correlations=args.correlations)

        # plot roc
        plot_roc_from_events(events, args.signal_mask, outputdir,
        ...
        plot_correlation_from_events(events, args.signal_mask, outputdir,
