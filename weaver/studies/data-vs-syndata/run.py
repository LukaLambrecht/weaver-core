...
if __name__=='__main__':
    ...
    # data config
    data_config = os.path.abspath('configs/data_config.yaml')
    # model config
    model_config = os.path.abspath('configs/model_part.py')
    # sample list for training data
    sample_config_train = os.path.abspath('configs/samples.yaml')
    # sample list for testing data
    sample_config_test = os.path.abspath('configs/samples.yaml')
    # output dir
