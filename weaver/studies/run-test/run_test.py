...
if __name__=='__main__':
    ...
    # data config
    data_config = os.path.join(weaverdir, 'configs/data/hh4b_mh125_vs_bkg/data_config_hh4b_mh125_vs_bkg_mlp_disco.yaml')
    #data_config = os.path.join(weaverdir, 'configs/data/hh4b_multimh_vs_bkg/data_config_hh4b_multimh_vs_bkg_mlp_disco.yaml')
    # model config
    ...
    network_kwargs += f' disco_label 0'
    network_kwargs += f' disco_mass_min 50'
    network_kwargs += f' disco_mass_max 200'
